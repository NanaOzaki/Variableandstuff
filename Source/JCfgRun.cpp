...
////£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  TPhase=FLOW_Noflow; MPCoef=0; ShiftCoef=0;
  ShiftGrad=TFloat3(0,0,0); 
////£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  TKernel=KERNEL_None;
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  if(Shifting){
	PrintVar("  Shifting Free Surface Gradient x",ShiftGrad.x,ln);
	PrintVar("  Shifting Free Surface Gradient y",ShiftGrad.y,ln);
	PrintVar("  Shifting Free Surface Gradient z",ShiftGrad.z,ln);
  }
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
	  else if(txword=="MULTIPHASE") {
		MPCoef=float(atof(txopt.c_str())); 
		if(MPCoef>100)ErrorParm(opt,c,lv,file);
		TPhase=FLOW_Multi;
	  }
	  else if(txword=="SINGLEPHASE")TPhase=FLOW_Single;
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
		...
		ShiftCoef=float(atof(txopt.c_str())); 
		if(ShiftCoef<-100)ErrorParm(opt,c,lv,file);
      }
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
      else if(txword=="ShiftGradX")ShiftGrad.x=float(atof(txopt.c_str())); 
      else if(txword=="ShiftGradY")ShiftGrad.y=float(atof(txopt.c_str())); 
      else if(txword=="ShiftGradZ")ShiftGrad.z=float(atof(txopt.c_str())); 
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
        ...
        double incx=atof(txopt.c_str()); 
        if(incx<0)ErrorParm(opt,c,lv,file);
        DomainMode=1;
        DomainParticlesMin=DomainParticlesMax=TDouble3(0);
        DomainParticlesPrcMin=DomainParticlesPrcMax=TDouble3(0);
        DomainParticlesPrcMax.x=incx;
      }
      else if(txword=="INCY"){ 
        double incy=atof(txopt.c_str()); 
        if(incy<0)ErrorParm(opt,c,lv,file);
        DomainMode=1;
        DomainParticlesMin=DomainParticlesMax=TDouble3(0);
        DomainParticlesPrcMin=DomainParticlesPrcMax=TDouble3(0);
        DomainParticlesPrcMax.y=incy;
      }
      else if(txword=="INCZ"){ 
