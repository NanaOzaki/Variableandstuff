...
/// Constructor.
//==============================================================================
JSphGpuSingle::JSphGpuSingle():JSphGpu(){
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  //Check whether surface tension will be used
  SurfCoef=Surft;
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//-Modifies the particle density data for the multiphase flow
  if(TPhase==FLOW_Multi){
	UpdateRhopMP(Np,Npb,AuxPos,Velrhop,Code);
    //-Copies multiphase data.
	PhaseData=JSph::GetPhaseData();
  }
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
/// Interaction for force computation.
//==============================================================================
void JSphGpuSingle::Interaction_ForcesMP(TpInter tinter){
 ...
 // if (IDCPU[p2] == 823){ std::cout << ARCPU[p2] << "\t"<< IDCPU[p2] <<"\n";system("PAUSE");}
  ...
  RhopMax=ComputeRhopMaxMP(ViscDtg);
...
//==============================================================================
void JSphGpuSingle::RunShifting_MP(double dt){
  const char met[]="RunShifting_MP";
  ...
  cusph::RunShifting_MP(Psimple,TKernel,CellMode,bsbound,bsfluid,Np,Npb,NpbOk,CellDivSingle->GetNcells(),CellDivSingle->GetBeginCell(),CellDivSingle->GetCellDomainMin(),Dcellg,Posxyg,Poszg,PsPospressg,Velrhopg,Codeg,Idpg,Aceg,Surfg,PhaseDatag,TShifting,ShiftCoef,ShiftTFS,ShiftPosg,ShiftDetectg,MkListSize,Simulate2D,NULL,dt);
  ...
  CheckCudaError(met,"Failed in particle shifting.");
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
//==============================================================================
/// Devuelve valor maximo de Rhopc[].
/// Returns the maximum value of Rhopc[]. -££//MP
//==============================================================================
double JSphGpuSingle::ComputeRhopMaxMP(float *auxmem){
  float rhopmax=0;
  const unsigned npf=Np-Npb;
  if(!PeriActive)cusph::ComputeRhopModMP(npf,Velrhopg+Npb,auxmem);//-Sin condiciones periodicas. //-Without periodic conditions.
  else cusph::ComputeRhopModMP(npf,Codeg+Npb,Velrhopg+Npb,auxmem);//-Con condiciones periodicas ignora las particulas periodicas. //-With periodic conditions ignores the periodic particles.
  if(npf)rhopmax=cusph::ReduMaxFloat(npf,0,auxmem,CellDivSingle->GetAuxMem(cusph::ReduMaxFloatSize(npf)));
  return(double(rhopmax));
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//-Calcula nuevo dt //-Calculate new dt
...
//-Actualiza particulas usando Verlet //-Update particle data using Verlet
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  ...
  //-Calcula dt del predictor //-Computes dt in the predictor step
  const double ddt_p=DtVariable(false);
  //-Particle Shifting - Surface Tension
  if(TShifting){
	  //if(TPhase==FLOW_Multi)RunShifting_MP(dt*.5);				//-Removed shifting for multi-phase flows from the predictor step
	  ///else RunShifting(dt*.5);
	  if(TPhase==FLOW_Single)RunShifting(dt*.5);					//-Single-phase
  }
//-Aplica Symplectic-Predictor a las particulas //Applies Symplectic-Predictor to the particles
...
//-Calcula dt del corrector //Computes dt in the corrector step
...
//-Aplica Symplectic-Corrector a las particulas //Applies Symplectic-Corrector to the particles
...
//==============================================================================
/// Genera los ficheros de salida de datos
/// Generates output files for particle data for the multi-phase flows -££//MP
//==============================================================================
void JSphGpuSingle::SaveDataMP(){
  const bool save=(SvData!=SDAT_None&&SvData!=SDAT_Info);
  const unsigned npsave=Np-NpbPer-NpfPer; //-Resta las periodicas si las hubiera. //-Subtracts periodic particles if any.
  //-Recupera datos de particulas en GPU.
  //-Retrieves particle data from the GPU.
  if(save){
    TmgStart(Timers,TMG_SuDownData);
    unsigned npnormal=ParticlesDataDown(Np,0,true,true,PeriActive!=0);
    if(npnormal!=npsave)RunException("SaveData","The number of particles is invalid.");
    TmgStop(Timers,TMG_SuDownData);
  }
  //-Recupera datos de floatings en GPU.
  ...
  //-Stores particle data.
  const tdouble3 vdom[2]={OrderDecode(CellDivSingle->GetDomainLimits(true)),OrderDecode(CellDivSingle->GetDomainLimits(false))};
  JSph::SaveDataMP(npsave,Idp,AuxPos,AuxVel,AuxRhop,Code,1,vdom,&infoplus);
  TmgStop(Timers,TMG_SuSavePart);
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
