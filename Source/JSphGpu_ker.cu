  ...
  ,float &frx,float &fry,float &frz,float &frx1,float &fry1,float &frz1,float &frx2,float &fry2,float &frz2,float &wab,const double Dp1, const double Dp2, const double H1, const double H2, float Awen1, float Awen2, float Bwen1, float Bwen2 )
{
  ...
  float qq2=rad/H2;
	if (qq2<=2.0f){
		...
		frx1=frx2=fry1=fry2=frz1=frz2=frx=fry=frz=0;
	}
  ...
  ,TpShifting tshifting,float *shiftdetect)
{
  ...
  //        }
  //      }
  //      //if(pfin) KerCorrectHneighbourlistBound(pini,pfin,code,phasetype1,bounddata,H1,newH); //PROBABLY WRONG
		//		if(pfin) KerCorrectHneighbourlistFluid(pini,pfin,code,phasetype1,accdata,H1,newH); //PROBABLY CORRECT
  //    }
  //  }
