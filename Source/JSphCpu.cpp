...
// Constructor.
//==============================================================================
JSphCpu::JSphCpu(bool use_mpi):JSph(true){
  ClassName="JSphCpu";
  CellDiv=NULL;
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  if(TPhase==FLOW_Multi) {
	...
	MemCpuParticles+=multi;
  }
  if(SurfCoef){
	  ArraysCpu->AddArrayCount(JArraysCpu::SIZE_24B,1);   //-surfg
  }
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  if(TPhase==FLOW_Multi){
    PhaseDatac=new StPhaseData[MkListSize];
  }
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
}
...
//==============================================================================
/// Prepara variables para interaccion "INTER_Forces" o "INTER_ForcesCorr".
/// Prepare variables for interaction functions "INTER_Forces" or "INTER_ForcesCorr". -££//MP
//==============================================================================
void JSphCpu::PreInteractionVars_ForcesMP(TpInter tinter,unsigned np,unsigned npb,word *code){
  //-Initialize Arrays / Inicializa arrays.
  const unsigned npf=np-npb;
  memset(Arc,0,sizeof(float)*np);                                    //Arc[]=0
  if(Deltac)memset(Deltac,0,sizeof(float)*np);                       //Deltac[]=0
  ...
  for(unsigned p=npb;p<np;p++)Acec[p]=Gravity;                       //Acec[]=Gravity for fluid / para fluid
  if(SpsGradvelc)memset(SpsGradvelc+npb,0,sizeof(tsymatrix3f)*npf);  //SpsGradvelc[]=(0,0,0,0,0,0).
  if(SurfCoef)memset(Surfc+npb,0,sizeof(tsymatrix3f)*npf);			 //Surfc[]=(0,0,0,0,0,0).
  ...
  float rhop0max=0.f;
  const int n=int(np); 
  const int nphase=int(MkListSize);
  for(int ipres=0; ipres<nphase; ipres++){
	rhop0max=((PhaseData[ipres].PhaseRhop0>rhop0max)? PhaseData[ipres].PhaseRhop0 : rhop0max);
  }
  #ifdef _WITHOMP
    #pragma omp parallel for schedule (static) if(n>LIMIT_COMPUTELIGHT_OMP)
  #endif
  for(int p=0;p<n;p++){
    float rhop0,cs0,gamma; unsigned phasetype;
	for(int ipres=0; ipres<nphase; ipres++){
		if(CODE_GetTypeAndValue(code[p])==PhaseData[ipres].MkValue){
			rhop0=PhaseData[ipres].PhaseRhop0;
			cs0=PhaseData[ipres].PhaseCs0;
			gamma=PhaseData[ipres].PhaseGamma;
			phasetype=PhaseData[ipres].PhaseType;
			break;
		}
	}
    float bconst=cs0*cs0*rhop0/gamma;
    const float rhop=Velrhopc[p].w,rhop_r0=rhop/rhop0;
    Pressc[p]=bconst*(pow(rhop_r0,gamma)-1.0f);
	if (phasetype==1){
		float airco=1.5f*MPCoef*H*9.81f*rhop0max/rhop0;
		Pressc[p]-=airco*rhop*rhop; //add cohesion term for gases
	}
  }
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
/// Prepare variables for interaction functions "INTER_Forces" or "INTER_ForcesCorr".
//==============================================================================
void JSphCpu::PreInteraction_ForcesMP(TpInter tinter){
  TmcStart(Timers,TMC_CfPreForces);
  //-Assign memory / Asigna memoria.
  Arc=ArraysCpu->ReserveFloat();
  Acec=ArraysCpu->ReserveFloat3();
  ...
  if(TVisco==VISCO_LaminarSPS)SpsGradvelc=ArraysCpu->ReserveSymatrix3f();
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  if(SurfCoef) Surfc=ArraysCpu->ReserveSymatrix3f();
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  ...
  //-Initialize Arrays / Inicializa arrays.
  PreInteractionVars_ForcesMP(tinter,Np,Npb,Codec);
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  ArraysCpu->Free(Surfc);		 Surfc=NULL;
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
}
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
//==============================================================================
/// Return values of Wendland kernel and its gradients: wab, frx, fry and frz. -££//MP
//==============================================================================
void JSphCpu::GetKernelShift(float rr2,float drx,float dry,float drz,float &frx,float &fry,float &frz,float &wab)const{
  const float rad=sqrt(rr2);
  const float qq=rad/H;
  //-Wendland kernel
  const float wqq1=1.f-0.5f*qq;
  const float fac=Bwen*qq*wqq1*wqq1*wqq1/rad;
  frx=fac*drx; fry=fac*dry; frz=fac*drz;
  wab=Awen*(2.f*qq+1.f)*wqq1*wqq1*wqq1*wqq1;
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//------------------------------------------------------------------------------
void JSphCpu::GetTensWendland(float wab,float &tens)const{
  float coefr=0.2f;
  const float rad=float(sqrt(Dp));
  const float qq=rad/H;
  //-Wendland kernel
  const float wqq1=1.f-0.5f*qq;
  const float wqq2=wqq1*wqq1;
  float wabti=Awen*(2.f*qq+1.f)*wqq2*wqq2;
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
//==============================================================================
/// Return the values of  Cubic kernel and its gradients without tensile correction: wab, frx, fry and frz. -££//MP
//==============================================================================
void JSphCpu::GetKernelCubicShift(float rr2,float drx,float dry,float drz,float &frx,float &fry,float &frz,float &wab)const{
  const float rad=sqrt(rr2);
  const float qq=rad/H;
  //-Cubic Spline kernel
  float fac;
  if(rad>H){
    ...
    float wqq2=qq*qq;
    fac=(CubicCte.c1*qq+CubicCte.d1*wqq2)/rad;
	wab=CubicCte.a2*(1.0f-1.5f*wqq2+0.75f*wqq2*qq);
  }
  //-Gradients.
  frx=fac*drx; fry=fac*dry; frz=fac*drz;
}
...
//------------------------------------------------------------------------------
void JSphCpu::GetTensCubic(float wab,float &tens)const{
  float coefr=0.2f;
  const float rad=float(sqrt(Dp));
  const float qq=rad/H;
  float wabti;
  ...
  if(rad>H){
    float wqq1=2.0f-qq;
    float wqq2=wqq1*wqq1;
	wabti=CubicCte.a24*(wqq2*wqq1);
  }
  else{
    float wqq2=qq*qq;
	wabti=CubicCte.a2*(1.0f-1.5f*wqq2+0.75f*wqq2*qq);
  }
  float wab1=(wab/wabti)*(wab/wabti);
  tens=coefr*wab1*wab1;
}
...
//==============================================================================
void JSphCpu::ShiftingFreeSurface(const tfloat3 concgr,tfloat3 &congr)const{
	tfloat3 norm=TFloat3(concgr.x,concgr.y,concgr.z);
	...
	if(ShiftGrad.x || ShiftGrad.y || ShiftGrad.z){
		congr.x+=0.1f*(dcdn*norm.x-ShiftGrad.x)*norm.x;
		congr.y+=0.1f*(dcdn*norm.y-ShiftGrad.y)*norm.y;
		congr.z+=0.1f*(dcdn*norm.z-ShiftGrad.z)*norm.z;
	}
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//==============================================================================
/// Realiza interaccion entre particulas. Bound-Fluid/Float
/// Perform interaction between particles. Bound-Fluid/Float -££//MP
//==============================================================================
template<bool psimple,TpKernel tker,TpFtMode ftmode,bool shift> void JSphCpu::InteractionForcesBoundMP
  (unsigned n,unsigned pinit,tint4 nc,int hdiv,unsigned cellinitial
  ,const unsigned *beginendcell,tint3 cellzero,const unsigned *dcell
  ,const tdouble3 *pos,const tfloat3 *pspos,const tfloat4 *velrhop,const word *code,const unsigned *idp
  ,float &viscdt,float *ar,StPhaseData *phasedata
  ,TpShifting tshifting,float *shiftdetect)const
{
  //-Initialize viscth to calculate max viscdt with OpenMP / Inicializa viscth para calcular visdt maximo con OpenMP.
  float viscth[MAXTHREADS_OMP*STRIDE_OMP];
  for(int th=0;th<OmpThreads;th++)viscth[th*STRIDE_OMP]=0;
  ...
  for(int p1=int(pinit);p1<pfin;p1++){
	...
	float massp1;
	for(int iphase=0; iphase<int(MkListSize); iphase++){ 
		if(CODE_GetTypeAndValue(code[p1])==phasedata[iphase].MkValue){
			massp1=phasedata[iphase].PhaseMass;
			break;
		}
	}
    float shiftdetectp1=0.f;
	if(shift) shiftdetectp1=(tker==KERNEL_Wendland? massp1*Awen/rhopp1:massp1*CubicCte.a2/rhopp1);
      ...
      for(int y=yini;y<yfin;y++){
        ...
        for(unsigned p2=pini;p2<pfin;p2++){
          ...
          if(rr2<=Fourh2 && rr2>=ALMOSTZERO){
			...
			float massp2;
			for(int iphase=0; iphase<int(MkListSize); iphase++){
				if(CODE_GetTypeAndValue(code[p2])==phasedata[iphase].MkValue){
				  massp2=phasedata[iphase].PhaseMass;
				  break;
				}
			}
            //-Wendland or Cubic Spline kernel.
            float frx,fry,frz,wab;
            if(tker==KERNEL_Wendland)GetKernelShift(rr2,drx,dry,drz,frx,fry,frz,wab);
            else if(tker==KERNEL_Cubic)GetKernelCubicShift(rr2,drx,dry,drz,frx,fry,frz,wab);
            ...
            if(USE_FLOATING){
              ...
              compute=!(USE_DEM && ftp2) || (!boundtrue); //-Deactivate when using DEM and/or bound-float or when used with bundary particles / Se desactiva cuando se usa DEM y es bound-float.
            }

            if(compute){
              //-Density derivative
              const float dvx=velp1.x-velrhop[p2].x, dvy=velp1.y-velrhop[p2].y, dvz=velp1.z-velrhop[p2].z;
              if(compute)arp1+=massp2*(dvx*frx+dvy*fry+dvz*frz)*rhopp1/velrhop[p2].w;
			...
			//-Particle shifting of Mokos et al.
...
//==============================================================================
/// Realiza interaccion entre particulas: Fluid/Float-Fluid/Float or Fluid/Float-Bound
/// Perform interaction between particles: Fluid/Float-Fluid/Float or Fluid/Float-Bound -££//MP
//==============================================================================
template<bool psimple,TpKernel tker,TpFtMode ftmode,bool lamsps,TpDeltaSph tdelta,bool shift> void JSphCpu::InteractionForcesFluidMP
  (unsigned n,unsigned pinit,tint4 nc,int hdiv,unsigned cellinitial
  ,const unsigned *beginendcell,tint3 cellzero,const unsigned *dcell
  ,const tsymatrix3f* tau,tsymatrix3f* gradvel
  ,const tdouble3 *pos,const tfloat3 *pspos,const tfloat4 *velrhop,const word *code,const unsigned *idp
  ,const float *press 
  ,float &viscdt,float *ar,tfloat3 *ace,float *delta
  ,tsymatrix3f *surf,StPhaseData *phasedata
  ,TpShifting tshifting,tfloat3 *shiftpos,float *shiftdetect)const
{
  const bool boundp2=(!cellinitial); //-Interaction with type boundary (Bound) /  Interaccion con Bound.
  //-Initialize viscth to calculate viscdt maximo con OpenMP / Inicializa viscth para calcular visdt maximo con OpenMP.
  ...
  for(int p1=int(pinit);p1<pfin;p1++){
	...
	//-Load unique properties for each phase
	float visco1=0.f; unsigned phasetype1=0; float rhop01=0.f; float massp1=0.f; float surf1=0.f;
	for(int iphase=0; iphase<int(MkListSize); iphase++){
		if(CODE_GetTypeAndValue(code[p1])==phasedata[iphase].MkValue){
			visco1=phasedata[iphase].PhaseVisco;
			phasetype1=phasedata[iphase].PhaseType;
			rhop01=phasedata[iphase].PhaseRhop0;
			massp1=phasedata[iphase].PhaseMass;
			surf1=phasedata[iphase].PhaseSurf;
			break;
		}
	}
    ...
    const float rhopp1=velrhop[p1].w;
    float shiftdetectp1=0.f;
	if(shift) shiftdetectp1=shiftdetect[p1];
	if(shift && !shiftdetectp1) shiftdetectp1=(tker==KERNEL_Wendland? massp1*Awen/rhopp1:massp1*CubicCte.a2/rhopp1);
    const tfloat3 psposp1=(psimple? pspos[p1]: TFloat3(0));
    const tdouble3 posp1=(psimple? TDouble3(0): pos[p1]);
    const float pressp1=press[p1];
    const tsymatrix3f taup1=(lamsps? tau[p1]: gradvelp1);
    ...
    for(int z=zini;z<zfin;z++){
      ...
      for(int y=yini;y<yfin;y++){
        ...
        for(unsigned p2=pini;p2<pfin;p2++){
          ...
          if(rr2<=Fourh2 && rr2>=ALMOSTZERO){
			//-Load unique properties for each phase
			float massp2=0.f; float visco2=0.f; unsigned phasetype2=0; float cs02=0.f; float rhop0max=0.f;
			for(int iphase=0; iphase<int(MkListSize); iphase++){
				if(CODE_GetTypeAndValue(code[p2])==phasedata[iphase].MkValue){
				  massp2=phasedata[iphase].PhaseMass;
				  visco2=phasedata[iphase].PhaseVisco;
				  phasetype2=phasedata[iphase].PhaseType;
				  cs02=phasedata[iphase].PhaseCs0;
				  break;
				}
				rhop0max=((phasedata[iphase].PhaseRhop0>rhop0max)? phasedata[iphase].PhaseRhop0 : rhop0max);
			}
            //-Wendland or Cubic Spline kernel.
            float frx,fry,frz,wab;
            if(tker==KERNEL_Wendland)GetKernelShift(rr2,drx,dry,drz,frx,fry,frz,wab);
            ...
            if(compute){
			  ...
			  if(phasetype1==1 && phasetype2==1){ 
				const float rhopmp=2.f*rhop01*rhop01;
				const float airco=1.5f*MPCoef*H*9.81f*rhop0max/(rhop01*rhop01);
				const float cohterm=airco*rhopmp*massp2*ftmassp1/(rhopp1*velrhop[p2].w);
				acep1.x+=cohterm*frx;
				acep1.y+=cohterm*fry; 
				acep1.z+=cohterm*frz;
			  }
			...
			//-Particle shiftingof Mokos et al.
			const float massrhop=massp2/velrhop[p2].w;
			if(shift) shiftdetectp1+=massrhop*wab;

			//===== Colour function gradient ===== //used to compute surface tension
			if (surf1){
				if(CODE_GetTypeAndValue(code[p1])!=CODE_GetTypeAndValue(code[p2])){
            ...
            if(compute){
              ...
              if(!lamsps){//-Artificial viscosity 
                if(dot<0){
                  const float amubar=H*dot_rr2;  //amubar=CTE.h*dot/(rr2+CTE.eta2);
                  const float robar=(rhopp1+velrhop[p2].w)*0.5f;
                  const float pi_visc=(-visco2*cbar*amubar/robar)*massp2*ftmassp1;
                  acep1.x-=pi_visc*frx; acep1.y-=pi_visc*fry; acep1.z-=pi_visc*frz;
                }
              }
              else{//-Laminar+SPS viscosity 
                {//-Laminar contribution.
                  const float robar2=(rhopp1+velrhop[p2].w);
                  const float temp=2.f*(visco1+visco2)/((rr2+Eta2)*robar2);  //-Simplification of / Simplificacion de: temp=2.0f*visco/((rr2+CTE.eta2)*robar); robar=(rhopp1+velrhop2.w)*0.5f;
                  const float vtemp=massp2*temp*(drx*frx+dry*fry+drz*frz);  
                  acep1.x+=vtemp*dvx; acep1.y+=vtemp*dvy; acep1.z+=vtemp*dvz;
                }
                //-SPS turbulence model.
    ...
    if(shift||arp1||acep1.x||acep1.y||acep1.z||visc){
	  ...
	  if(surf1){
		tsymatrix3f pi_surf1={0,0,0,0,0,0};
		...
		if (gradcnorm!=0 && gradcnorm==gradcnorm){
			float sigma=surf1/gradcnorm;
			pi_surf1.xx=sigma*(gradcsq-shiftposp1.x*shiftposp1.x);
			pi_surf1.xy=-sigma*shiftposp1.x*shiftposp1.y;
			pi_surf1.xz=-sigma*shiftposp1.x*shiftposp1.z;
			pi_surf1.yy=sigma*(gradcsq-shiftposp1.y*shiftposp1.y);
			pi_surf1.yz=-sigma*shiftposp1.y*shiftposp1.z;
			pi_surf1.zz=sigma*(gradcsq-shiftposp1.z*shiftposp1.z);
		}
	    surf[p1]=pi_surf1;
	  }
    }
...
//==============================================================================
/// Seleccion de parametros template para Interaction_ForcesFluidT.
/// Selection of template parameters for Interaction_ForcesFluidT. -££//MP
//==============================================================================
template<bool psimple,TpKernel tker,TpFtMode ftmode,bool lamsps,TpDeltaSph tdelta,bool shift> void JSphCpu::Interaction_ForcesMPT
  (unsigned np,unsigned npb,unsigned npbok
  ,tuint3 ncells,const unsigned *begincell,tuint3 cellmin,const unsigned *dcell
  ,const tdouble3 *pos,const tfloat3 *pspos,const tfloat4 *velrhop,const word *code,const unsigned *idp
  ,const float *press
  ...
  ,TpShifting tshifting,tfloat3 *shiftpos,float *shiftdetect)const
{
  ...
  if(npf){
    //-Interaction Fluid-Fluid / Interaccion Fluid-Fluid
    InteractionForcesFluidMP<psimple,tker,ftmode,lamsps,tdelta,shift> (npf,npb,nc,hdiv,cellfluid,begincell,cellzero,dcell,spstau,spsgradvel,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,surf,phasedata,tshifting,shiftpos,shiftdetect);

	//-Interaction Fluid-Bound
	InteractionForcesFluidMP<psimple,tker,ftmode,lamsps,tdelta,shift> (npf,npb,nc,hdiv,0        ,begincell,cellzero,dcell,spstau,spsgradvel,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,surf,phasedata,tshifting,shiftpos,shiftdetect);
  ...
  if(npbok){
    //-Interaction of type Bound-Fluid / Interaccion Bound-Fluid
    InteractionForcesBoundMP      <psimple,tker,ftmode,shift> (npbok,0,nc,hdiv,cellfluid,begincell,cellzero,dcell,pos,pspos,velrhop,code,idp,viscdt,ar,phasedata,tshifting,shiftdetect);
  }
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//==============================================================================
/// Seleccion de parametros template para Interaction_ForcesX.
/// Selection of template parameters for Interaction_ForcesX. -££//MP
//==============================================================================
void JSphCpu::Interaction_ForcesMP(unsigned np,unsigned npb,unsigned npbok
  ,tuint3 ncells,const unsigned *begincell,tuint3 cellmin,const unsigned *dcell
  ,const tdouble3 *pos,const tfloat4 *velrhop,const unsigned *idp,const word *code
  ,const float *press
  ,float &viscdt,float* ar,tfloat3 *ace,float *delta
  ...
  ,tfloat3 *shiftpos,float *shiftdetect)const
{
  ...
  if(TKernel==KERNEL_Wendland){          const TpKernel tker=KERNEL_Wendland;
    if(!WithFloating){                   const TpFtMode ftmode=FTMODE_None;
      if(TShifting){                     const bool tshift=true;
        if(TVisco==VISCO_LaminarSPS){    const bool lamsps=true;
          if(TDeltaSph==DELTA_None)      Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_None,tshift>       (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
          if(TDeltaSph==DELTA_Dynamic)   Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_Dynamic,tshift>    (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
          if(TDeltaSph==DELTA_DynamicExt)Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_DynamicExt,tshift> (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
        }else{                           const bool lamsps=false;
          if(TDeltaSph==DELTA_None)      Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_None,tshift>       (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
          if(TDeltaSph==DELTA_Dynamic)   Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_Dynamic,tshift>    (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
          if(TDeltaSph==DELTA_DynamicExt)Interaction_ForcesMPT<psimple,tker,ftmode,lamsps,DELTA_DynamicExt,tshift> (np,npb,npbok,ncells,begincell,cellmin,dcell,pos,pspos,velrhop,code,idp,press,viscdt,ar,ace,delta,spstau,spsgradvel,surf,phasedata,TShifting,shiftpos,shiftdetect);
...
/// Selection of template parameters for Interaction_ForcesX. -££//MP
//==============================================================================
void JSphCpu::InteractionSimple_ForcesMP(unsigned np,unsigned npb,unsigned npbok
  ,tuint3 ncells,const unsigned *begincell,tuint3 cellmin,const unsigned *dcell
  ,const tfloat3 *pspos,const tfloat4 *velrhop,const unsigned *idp,const word *code
  ,const float *press
  ,float &viscdt,float* ar,tfloat3 *ace,float *delta
...
//==============================================================================
/// Calculate new values of position, velocity & density for fluid (using Verlet).
/// Used for multiphase due to different initial densities.
//==============================================================================
template<bool shift> void JSphCpu::ComputeVerletVarsFluidMP(const tfloat4 *velrhop1,const tfloat4 *velrhop2,double dt,double dt2
  ,tdouble3 *pos,unsigned *dcell,word *code,tfloat4 *velrhopnew,StPhaseData *phasedata)const
{
  const double dt205=0.5*dt*dt;
  const int pini=int(Npb),pfin=int(Np),npf=int(Np-Npb);
  #ifdef _WITHOMP
  ...
  for(int p=pini;p<pfin;p++){
    ...
    if(!WithFloating || CODE_GetType(code[p])==CODE_TYPE_FLUID){//-Fluid Particles / Particulas: Fluid
      ...
      velrhopnew[p].w=(rhopnew<rhop01? rhop01: rhopnew); //-Avoid fluid particles being absorved by floating ones / Evita q las floating absorvan a las fluidas.
    }
  }
}
...
//==============================================================================
/// Calculate new values of density and set velocity=zero for cases of  
/// (fixed+moving, no floating). Changed initial density to deal with multiple phases -££//MP
//==============================================================================
void JSphCpu::ComputeVelrhopBoundMP(const tfloat4* velrhopold,double armul,tfloat4* velrhopnew,const word *code,StPhaseData *phasedata)const{
  const int npb=int(Npb);
  float rhop01;
  #ifdef _WITHOMP
    #pragma omp parallel for schedule (static) if(npb>LIMIT_COMPUTESTEP_OMP)
  ...
  for(int p=0;p<npb;p++){
    ...
    const float rhopnew=float(double(velrhopold[p].w)+armul*Arc[p]);
    velrhopnew[p]=TFloat4(0,0,0,(rhopnew<rhop01? rhop01: rhopnew));//-Avoid fluid particles being absorved by boundary ones / Evita q las boundary absorvan a las fluidas.
  }
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
//==============================================================================
/// Actualizacion de particulas segun fuerzas y dt usando Verlet.
/// Update of particles according to forces and dt using Verlet. -££//MP
//==============================================================================
void JSphCpu::ComputeVerletMP(double dt){
  TmcStart(Timers,TMC_SuComputeStep);
  VerletStep++;
  if(VerletStep<VerletSteps){
    const double twodt=dt+dt;
    if(TShifting)ComputeVerletVarsFluidMP<true>  (Velrhopc,VelrhopM1c,dt,twodt,Posc,Dcellc,Codec,VelrhopM1c,PhaseDatac);
    else         ComputeVerletVarsFluidMP<false> (Velrhopc,VelrhopM1c,dt,twodt,Posc,Dcellc,Codec,VelrhopM1c,PhaseDatac);
	ComputeVelrhopBoundMP(VelrhopM1c,twodt,VelrhopM1c,Codec,PhaseDatac);
  }
  else{
    if(TShifting)ComputeVerletVarsFluidMP<true>  (Velrhopc,Velrhopc,dt,dt,Posc,Dcellc,Codec,VelrhopM1c,PhaseDatac);
    else         ComputeVerletVarsFluidMP<false> (Velrhopc,Velrhopc,dt,dt,Posc,Dcellc,Codec,VelrhopM1c,PhaseDatac);
	ComputeVelrhopBoundMP(Velrhopc,dt,VelrhopM1c,Codec,PhaseDatac);
    VerletStep=0;
  }
  //-New values are calculated en VelrhopM1c / Los nuevos valores se calculan en VelrhopM1c.
  swap(Velrhopc,VelrhopM1c);     //-Swap Velrhopc & VelrhopM1c / Intercambia Velrhopc y VelrhopM1c.
...
//==============================================================================
/// Actualizacion de particulas segun fuerzas y dt usando Symplectic-Predictor.
/// Update of particles according to forces and dt using Symplectic-Predictor. -££//MP
//==============================================================================
void JSphCpu::ComputeSymplecticPreMP(double dt){
  if(TShifting)ComputeSymplecticPreTMP<true> (dt);
  else         ComputeSymplecticPreTMP<false>(dt);
}
//==============================================================================
template<bool shift> void JSphCpu::ComputeSymplecticPreTMP(double dt){
  TmcStart(Timers,TMC_SuComputeStep);
  //-Assign memory to variables Pre / Asigna memoria a variables Pre.
  PosPrec=ArraysCpu->ReserveDouble3();
  VelrhopPrec=ArraysCpu->ReserveFloat4();
  ...
  for(int p=0;p<npb;p++){
	for(int iphase=0; iphase<int(MkListSize); iphase++){
		if(CODE_GetTypeAndValue(Codec[p])==PhaseDatac[iphase].MkValue){
			rhop0=PhaseDatac[iphase].PhaseRhop0;
			break;
		}
	}
    const tfloat4 vr=VelrhopPrec[p];
    const float rhopnew=float(double(vr.w)+dt05*Arc[p]);
    Velrhopc[p]=TFloat4(vr.x,vr.y,vr.z,(rhopnew<rhop0? rhop0: rhopnew));//-Avoid fluid particles being absorbed by boundary ones / Evita q las boundary absorvan a las fluidas.
  }
  ...
  for(int p=npb;p<np;p++){
    ...
    if(!WithFloating || CODE_GetType(Codec[p])==CODE_TYPE_FLUID){//-Fluid Particles / Particulas: Fluid
      ...
      double dy=double(VelrhopPrec[p].y)*dt05;
      double dz=double(VelrhopPrec[p].z)*dt05;
      //if(shift){						//-Removed shifting in the predictor step
      //  dx+=double(ShiftPosc[p].x);
      //  dy+=double(ShiftPosc[p].y);
      //  dz+=double(ShiftPosc[p].z);
      //}
      ...
      Velrhopc[p].w=(rhopnew<rhop0? rhop0: rhopnew); //-Avoid fluid particles being absorbed by floating ones / Evita q las floating absorvan a las fluidas.
      //-Copy position / Copia posicion.
      Posc[p]=PosPrec[p];
    }
  }
...
//==============================================================================
/// Actualizacion de particulas segun fuerzas y dt usando Symplectic-Corrector.
/// Update particles according to forces and dt using Symplectic-Corrector. -££//MP
//==============================================================================
void JSphCpu::ComputeSymplecticCorrMP(double dt){
  if(TShifting)ComputeSymplecticCorrTMP<true> (dt);
  else         ComputeSymplecticCorrTMP<false>(dt);
}
//==============================================================================
template<bool shift> void JSphCpu::ComputeSymplecticCorrTMP(double dt){
  TmcStart(Timers,TMC_SuComputeStep);
  ...
  for(int p=0;p<npb;p++){
    ...
    const double epsilon_rdot=(-double(Arc[p])/double(Velrhopc[p].w))*dt;
    const float rhopnew=float(double(VelrhopPrec[p].w) * (2.-epsilon_rdot)/(2.+epsilon_rdot));
    Velrhopc[p]=TFloat4(0,0,0,(rhopnew<rhop0? rhop0: rhopnew));//-Avoid fluid particles being absorbed by boundary ones / Evita q las boundary absorvan a las fluidas.
  }
...
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
  //-find the maximum speed of sound among the phases
  ...
  float surfmax=0;
  if(SurfCoef){
	for(unsigned isurf=0; isurf<MkListSize; isurf++) ((PhaseData[isurf].PhaseSurf>surfmax)? PhaseData[isurf].PhaseSurf : surfmax);
...
/// Calculate final Shifting for particles' position. (only for single-phase flows)
//==============================================================================
...
//==============================================================================
/// Calcula Shifting final para posicion de particulas.
/// Calculate final Shifting for particles' position according to Mokos et al. -££//MP
//==============================================================================
  template<bool psimple,TpKernel tker> void JSphCpu::RunShiftingInteractionMP(unsigned n,unsigned pinit,tint4 nc,int hdiv,unsigned cellfluid
  ,const unsigned *beginendcell,tint3 cellzero,const unsigned *dcell
  ,const tdouble3 *pos,const tfloat3 *pspos,const tfloat4 *velrhop,const word *code,const unsigned *idp
  ,tfloat3 *ace,tsymatrix3f *surf,StPhaseData *phasedata,TpShifting tshifting,tfloat3 *shiftpos,float *shiftdetect,double dt)const{
  ...
  #endif
  for(int p1=int(pinit);p1<pfin;p1++){
	//-Load unique propeeties of each phase
	unsigned phasetype1; float massp1; float surfcoef1;
	for(unsigned iphase=0; iphase<MkListSize; iphase++){
		if(CODE_GetTypeAndValue(code[p1])==phasedata[iphase].MkValue){
			phasetype1=phasedata[iphase].PhaseType;
			massp1=phasedata[iphase].PhaseMass;
			surfcoef1=phasedata[iphase].PhaseSurf;
			break;
		}
	}
    //-Obtain data of particle p1 / Obtiene datos de particula p1.
    const tfloat3 velp1=TFloat3(velrhop[p1].x,velrhop[p1].y,velrhop[p1].z);
    const float rhopp1=velrhop[p1].w;
    tfloat3 acep1=TFloat3(0,0,0);
    tfloat3 shiftposp1=TFloat3(0),norm1=TFloat3(0);
	...
	//-Diffusion coefficient of Skillen et al.
	...
	float diffc=0.5f*ShiftCoef*velsh*H*float(dt)/CFLnumber;
	float diffc2=-0.5f*sqrt(acemaxl)*float(dt)*H*H/sqrt(H);	
      ...
      for(int y=yini;y<yfin;y++){
        ...
        for(unsigned p2=pini;p2<pfin;p2++){
          ...
          if(rr2<=Fourh2 && rr2>=ALMOSTZERO){
			...
			if (surfcoef1 && CODE_GetType(code[p2])==CODE_TYPE_FLUID)surf2=surf[p2];
            //-Wendland or Cubic Spline kernel.
            float frx,fry,frz,wab;
            if(tker==KERNEL_Wendland)GetKernelShift(rr2,drx,dry,drz,frx,fry,frz,wab);
            else if(tker==KERNEL_Cubic)GetKernelCubicShift(rr2,drx,dry,drz,frx,fry,frz,wab);

			float vol2=massp2/velrhop[p2].w;

			//-Tensile Instability - Monaghan - Not used - Enable in particle divergence if needed
			float tens;
            if(tker==KERNEL_Wendland)GetTensWendland(wab,tens);
            else if(tker==KERNEL_Cubic)GetTensCubic(wab,tens);

			//-Different shifting options
			float shiftdetectp2=0;
			...
			//-Particle Divergence
			pdivall+=vol2*(drx*frx+dry*fry+drz*frz); //divergence for all particles
			if(phasetype1==phasetype2) {
				norm1.x+=consub*vol2*frx;//*(1.f+tens); 
				norm1.y+=consub*vol2*fry;//*(1.f+tens);
				norm1.z+=consub*vol2*frz;//*(1.f+tens);
				pdiv+=vol2*(drx*frx+dry*fry+drz*frz); //divergence for the same phase
			}
	...
	//-Free Surface Term
    tfloat3 congr1=TFloat3(0);
	if(phasetype1!=1 && (pdiv<ShiftTFS || pdiv!=pdivall))ShiftingFreeSurface(norm1,congr1);
    ...
    if(tshifting) shiftpos[p1]=shiftpos[p1]+congr1;
	ace[p1]=ace[p1]+acep1;
  }
}
//£££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££££//MP
...
/// Calculate final Shifting for particles' position according to Mokos et al. -££//MP
//==============================================================================
void JSphCpu::RunShiftingMP(unsigned np,unsigned npb,unsigned npbok
  ,tuint3 ncells,const unsigned *begincell,tuint3 cellmin,const unsigned *dcell
  ,const tdouble3 *pos,const tfloat4 *velrhop,const unsigned *idp,const word *code
  ,tfloat3 *ace,tsymatrix3f *surf,StPhaseData *phasedata,TpShifting tshifting,tfloat3 *shiftpos,float *shiftdetect,double dt)const{
  ...
  if(TKernel==KERNEL_Wendland){          const TpKernel tker=KERNEL_Wendland;
    RunShiftingInteractionMP<psimple,tker> (npf,npb,nc,hdiv,cellfluid,begincell,cellzero,dcell,pos,pspos,velrhop,code,idp,ace,surf,phasedata,tshifting,shiftpos,shiftdetect,dt);
    RunShiftingInteractionMP<psimple,tker> (npf,npb,nc,hdiv,0        ,begincell,cellzero,dcell,pos,pspos,velrhop,code,idp,ace,surf,phasedata,tshifting,shiftpos,shiftdetect,dt);
  }
  else  if(TKernel==KERNEL_Cubic){          const TpKernel tker=KERNEL_Cubic;
    RunShiftingInteractionMP<psimple,tker> (npf,npb,nc,hdiv,cellfluid,begincell,cellzero,dcell,pos,pspos,velrhop,code,idp,ace,surf,phasedata,tshifting,shiftpos,shiftdetect,dt);
    RunShiftingInteractionMP<psimple,tker> (npf,npb,nc,hdiv,0        ,begincell,cellzero,dcell,pos,pspos,velrhop,code,idp,ace,surf,phasedata,tshifting,shiftpos,shiftdetect,dt);
...
/// Calculate final Shifting for particles' position according to Mokos et al. -££//MP
//==============================================================================
void JSphCpu::RunShiftingSimpleMP(unsigned np,unsigned npb,unsigned npbok
  ,tuint3 ncells,const unsigned *begincell,tuint3 cellmin,const unsigned *dcell
  ,const tfloat3 *pspos,const tfloat4 *velrhop,const unsigned *idp,const word *code
  ,tfloat3 *ace,tsymatrix3f *surf,StPhaseData *phasedata,TpShifting tshifting,tfloat3 *shiftpos,float *shiftdetect,double dt)const{
